...
! function(e, t) {
    ...
    var i = o;
    var s = function(e, t, n, r, o, i, s, u) {
            if (!e) {
                var a;
        ...
        u = t(function(e) {
            e.exports = function() {
                function e(e, t, n, r, o, i) {
                    "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED" !== i && s(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types")
                }
        ...
        C = u.shape({
            trySubscribe: u.func.isRequired,
            tryUnsubscribe: u.func.isRequired,
            notifyNestedSubs: u.func.isRequired,
            isSubscribed: u.func.isRequired
        }),
        w = u.shape({
    ...
    function a(o) {
        ...
        var n = o + "Subscription",
            t = function(r) {
                ...
                function t(e, t) {
                    var n;
                    return (n = r.call(this, e, t) || this)[o] = e.store, n
                }
                return e.getChildContext = function() {
                    var e;
                    return (e = {})[o] = this[o], e[n] = null, e
                }, e.render = function() {
        ...
        }, t.childContextTypes = ((e = {})[o] = w.isRequired, e[n] = C, e), t
    }
    var c = a();
    ...
    var p, f = t(function(e, t) {
        ...
        var n = "function" == typeof Symbol && Symbol.for,
            ...
            l = n ? Symbol.for("react.memo") : 60115,
        ...
        t.typeOf = y, t.AsyncMode = p, t.ConcurrentMode = p, t.ContextConsumer = c, t.ContextProvider = a, t.Element = r, t.ForwardRef = f, t.Fragment = i, t.Profiler = u, t.Portal = o, t.StrictMode = s, t.isValidElementType = function(e) {
            return "string" == typeof e || "function" == typeof e || e === i || e === p || e === u || e === s || e === d || "object" == typeof e && null !== e && (e.$$typeof === h || e.$$typeof === l || e.$$typeof === a || e.$$typeof === c || e.$$typeof === f)
    ...
    (p = f) && p.__esModule && Object.prototype.hasOwnProperty.call(p, "default");
    var d = t(function(e) {
            e.exports = f
        }),
        R = d.isValidElementType,
        l = {
            childContextTypes: !0,
            contextType: !0,
            contextTypes: !0,
    ...
    var q = function e(t, n, r) {
            ...
            var i = v(n);
            m && (i = i.concat(m(n)));
            for (var s = y[t.$$typeof] || l, u = y[n.$$typeof] || l, a = 0; a < i.length; ++a) {
                var c = i[a];
                if (!(h[c] || r && r[c] || u && u[c] || s && s[c])) {
                    var p = P(n, c);
                    try {
                        b(t, c, p)
                    } catch (e) {}
    ...
    var $ = function() {
            function e(e, t, n) {
                this.store = e, this.parentSub = t, this.onStateChange = n, this.unsubscribe = null, this.listeners = j
            }
            var t = e.prototype;
            return t.addNestedSub = function(e) {
                ...
                this.unsubscribe && (this.unsubscribe(), this.unsubscribe = null, this.listeners.clear(), this.listeners = j)
            }, e
        }(),
        _ = 0,
        D = {};
    ...
    function I(s, e) {
        ...
        var r = e.getDisplayName,
            ...
            h = e.withRef,
            y = void 0 !== h && h,
            b = E(e, ["getDisplayName", "methodName", "renderCountProp", "shouldHandleStateChanges", "storeKey", "withRef"]),
            v = l + "Subscription",
            m = _++,
            P = ((t = {})[l] = w, t[v] = C, t),
            S = ((n = {})[v] = C, n);
        return function(n) {
            N(R(n), "You must pass a component to the function returned by " + a + ". Instead received " + JSON.stringify(n));
            var e = n.displayName || n.name || "Component",
                ...
                t = function(r) {
                    function e(e, t) {
                        var n;
                        return (n = r.call(this, e, t) || this).version = m, n.state = {}, n.renderCount = 0, n.store = e[l] || t[l], n.propsMode = !!e[l], n.setWrappedInstance = n.setWrappedInstance.bind(T(T(n))), N(n.store, 'Could not find "' + l + '" in either the context or props of "' + o + '". Either wrap the root component in a <Provider>, or explicitly pass "' + l + '" as a prop to "' + o + '".'), n.initSelector(), n.initSubscription(), n
                    }
                    O(e, r);
                    var t = e.prototype;
                    return t.getChildContext = function() {
                        var e;
                        return (e = {})[v] = (this.propsMode ? null : this.subscription) || this.context[v], e
                        ...
                        return N(y, "To access the wrapped instance, you need to specify { withRef: true } in the options argument of the " + a + "() call."), this.wrappedInstance
                    }, t.setWrappedInstance = function(e) {
                        this.wrappedInstance = e
                    }, t.initSelector = function() {
                        var n, r, o, e = s(this.store.dispatch, i);
                        ...
                        f && (this.subscription = new $(this.store, (this.propsMode ? this.props : this.context)[v], this.onStateChange.bind(this)), this.notifyNestedSubs = this.subscription.notifyNestedSubs.bind(this.subscription))
                        ...
                        if (!(y || c || this.propsMode && this.subscription)) return e;
                        var t = x({}, e);
                        return y && (t.ref = this.setWrappedInstance), c && (t[c] = this.renderCount++), this.propsMode && this.subscription && (t[v] = this.subscription), t
                    }, t.render = function() {
                        var e = this.selector;
                        if (e.shouldComponentUpdate = !1, e.error) throw e.error;
                        return g.createElement(n, this.addExtraProps(e.props))
                    }, e
                }(g.Component);
            return t.WrappedComponent = n, t.displayName = o, t.childContextTypes = S, t.contextTypes = P, t.propTypes = P, q(t, n)
        }
    }
    ...
    function A(e, t) {
        ...
        for (var r = 0; r < n.length; r++)
            if (!F.call(t, n[r]) || !W(e[n[r]], t[n[r]])) return !1;
        return !0
    }
    ...
    function V(o, e) {
        return function(e, t) {
            ...
            return r.dependsOnOwnProps = !0, r.mapToProps = function(e, t) {
                r.mapToProps = o, r.dependsOnOwnProps = H(o);
                var n = r(e, t);
                return "function" == typeof n && (r.mapToProps = n, r.dependsOnOwnProps = H(n), n = r(e, t)), n
            }, r
        }
    }
    ...
    function Y(s, u, a, c, e) {
        var p, f, d, l, h, y = e.areStatesEqual,
            b = e.areOwnPropsEqual,
            v = e.areStatePropsEqual,
            n = !1;

        function r(e, t) {
            var n, r, o = !b(t, f),
                i = !y(e, p);
            return p = e, f = t, o && i ? (d = s(p, f), u.dependsOnOwnProps && (l = u(c, f)), h = a(d, l, f)) : o ? (s.dependsOnOwnProps && (d = s(p, f)), u.dependsOnOwnProps && (l = u(c, f)), h = a(d, l, f)) : (i && (n = s(p, f), r = !v(n, d), d = n, r && (h = a(d, l, f))), h)
        }
        return function(e, t) {
            return n ? r(e, t) : (d = s(p = e, f = t), l = u(c, f), h = a(d, l, f), n = !0, h)
        }
    }
    ...
    function z(e, t) {
        var n = t.initMapStateToProps,
            ...
            o = t.initMergeProps,
            i = E(t, ["initMapStateToProps", "initMapDispatchToProps", "initMergeProps"]),
            s = n(e, i),
            u = r(e, i),
            a = o(e, i);
        return (i.pure ? Y : L)(s, u, a, e, i)
    }
    ...
    function B(n, e, r) {
        ...
        return function(e, t) {
            throw Error("Invalid value of type " + typeof n + " for " + r + " argument when connecting component " + t.wrappedComponentName + ".")
        }
    }
    ...
    var G, Q, X, Z, ee, te, ne, re, oe, ie, se, ue, ae = (Z = void 0 === (X = (Q = void 0 === G ? {} : G).connectHOC) ? I : X, te = void 0 === (ee = Q.mapStateToPropsFactories) ? [function(e) {
        return "function" == typeof e ? V(e) : void 0
    }, function(e) {
        return e ? void 0 : k(function() {
            return {}
        })
    }] : ee, re = void 0 === (ne = Q.mapDispatchToPropsFactories) ? [function(e) {
        return "function" == typeof e ? V(e) : void 0
    }, function(e) {
    ...
    }] : ne, ie = void 0 === (oe = Q.mergePropsFactories) ? [function(e) {
        return "function" == typeof e ? (a = e, function(e, t) {
            var o, i = t.pure,
                s = t.areMergedPropsEqual,
                u = !1;
            return function(e, t, n) {
                var r = a(e, t, n);
                return u ? i && s(r, o) || (o = r) : (u = !0, o = r), o
            }
        }) : void 0;
        var a
    }, function(e) {
    ...
    }] : oe, ue = void 0 === (se = Q.selectorFactory) ? z : se, function(e, t, n, r) {
        void 0 === r && (r = {});
        var o = r.pure,
            i = void 0 === o || o,
            s = r.areStatesEqual,
            ...
            f = void 0 === p ? A : p,
            d = r.areMergedPropsEqual,
            l = void 0 === d ? A : d,
            h = E(r, ["pure", "areStatesEqual", "areOwnPropsEqual", "areStatePropsEqual", "areMergedPropsEqual"]),
            y = B(e, te, "mapStateToProps"),
            b = B(t, re, "mapDispatchToProps"),
            v = B(n, ie, "mergeProps");
        return Z(ue, x({
            methodName: "connect",
    ...
    e.Provider = c, e.createProvider = a, e.connectAdvanced = I, e.connect = ae, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
...
! function(e, r) {
    if ("function" == typeof define && define.amd) define("Reselect", ["exports"], r);
    ...
    function a(e) {
        var r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : o,
            t = null,
            n = null;
        return function() {
            return function(e, r, t) {
                ...
                return !0
            }(r, t, arguments) || (n = e.apply(null, arguments)), t = arguments, n
        }
    }

    function r(l) {
        for (var e = arguments.length, f = Array(1 < e ? e - 1 : 0), r = 1; r < e; r++) f[r - 1] = arguments[r];
        return function() {
            ...
            var n = 0,
                ...
                i = a(function() {
                    for (var e = [], r = u.length, t = 0; t < r; t++) e.push(u[t].apply(null, arguments));
    ...
    e.__esModule = !0, e.defaultMemoize = a, e.createSelectorCreator = r, e.createStructuredSelector = function(r) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : t;
        if ("object" != typeof r) throw new Error("createStructuredSelector expects first argument to be an object where each property is a selector, instead received a " + typeof r);
        var n = Object.keys(r);
