...
*/
    ...
    var games = function() {
        ...
        }, "Play another?"), d.createElement("h4", {
            className: "sb-modal-heading"
        }, "Try one of these Buzzwords:"), d.createElement("ul", {
            className: "sb-modal-list"
        }, Object.keys(window.gameData.links).map(function(e) {
...
*/
    ...
    function me(e) {
        var t = e.children,
            n = e.toggleModal,
            r = e.modalType,
            // Items in this list are left-aligned, which get style sheets added
            // we want for menu items! Buzz: added 'games'
            o = [games, j, A, de].includes(pe[r]),
            ...
            case Me:
                return Se({}, t, {
                    outerLetters: function e(t, n) {
                        console.log("outerletters - t: " + t + " - n: " + n)
